...
internal record Machine(Button A, Button B, long X, long Y)
{
...
public static class Day13
{
    ...
    internal static long[] ParseDigits(this string input)
    {
        return Regex.Matches(input, "[0-9]+", RegexOptions.Singleline)
